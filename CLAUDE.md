...
metadata (PR #10), #5 API key and rate limiting (PR #11), #6 person-name detection (PR #12),
#14 post-review performance & correctness fixes (PR #15). TASKS.md holds the checklist for the
issue in progress plus the queue. Reference the issue in commit messages (`Refs #<n>`, `Closes #<n>`).
